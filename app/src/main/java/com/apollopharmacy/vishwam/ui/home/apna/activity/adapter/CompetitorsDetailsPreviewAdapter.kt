...
class CompetitorsDetailsPreviewAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.chemistAdapterLayoutBinding.avgsale.setText("\u20B9" + DecimalFormat("##,##,##0").format(data[position].orgAvgSale!!.toLong()))
        holder.chemistAdapterLayoutBinding.unorganized.setText(data[position].unorganised!!.uid)
        holder.chemistAdapterLayoutBinding.unorganisedAvgSale.setText("\u20B9" + DecimalFormat("##,##,##0").format(data[position].unorgAvgSale!!.toLong()))
    }
