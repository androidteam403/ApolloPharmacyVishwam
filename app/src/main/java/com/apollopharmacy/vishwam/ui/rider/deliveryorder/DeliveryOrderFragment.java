package com.apollopharmacy.vishwam.ui.rider.deliveryorder;
    ...
    void onVerifyOtpBtnClick() {
        if (pinHiddenEditText.getText().toString().equalsIgnoreCase("000000")) {
            ...
            new Handler().postDelayed(() -> {
                ((MainActivity) Objects.requireNonNull(mActivity)).showFragment(new DashboardFragment(), R.string.menu_dashboard);
                ((MainActivity) Objects.requireNonNull(mActivity)).updateSelection(1);
            }, 1000);
        } else {
...
//        builder.create().show();
    ...
    public void toggleBottomSheet() {
        ...
        cancelHeaderText.setText("Write reason below for cancel the order");
