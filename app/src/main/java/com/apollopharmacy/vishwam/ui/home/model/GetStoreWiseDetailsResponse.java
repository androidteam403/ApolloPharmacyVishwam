...
public class GetStoreWiseDetailsResponse implements Serializable {
    ...
    public GetStoreWiseDetailsResponse withMessage(Object message) {
        this.message = message;
        return this;
    }
    ...
    public GetStoreWiseDetailsResponse withSuccess(Boolean success) {
        this.success = success;
        return this;
    }
    ...
    public GetStoreWiseDetailsResponse withData(Data data) {
        this.data = data;
        return this;
    }
