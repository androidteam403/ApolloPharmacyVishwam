...
//            ((subCategoryDetails.get(position).rating)!!.toFloat()*2).toInt()
        var seekBar: IndicatorSeekBar = IndicatorSeekBar
            .with(applicationContext)
            .max(subCategory.rating!!.toFloat())
            .min(0f)
            .progress(0f)

            .tickCount(5)
            .showTickMarksType(TickMarkType.OVAL)
            .tickMarksColor(R.color.apollo_btn_color)
            .tickMarksSize(13) //dp
            .showTickTexts(true)
            .tickTextsColor(R.color.red)
            .tickTextsSize(13) //sp
            .tickTextsTypeFace(Typeface.MONOSPACE)
            .showIndicatorType(IndicatorType.ROUNDED_RECTANGLE)
            .indicatorColor(R.color.bluee_color)
            .indicatorTextColor(Color.parseColor("#ffffff"))
            .indicatorTextSize(13) //sp
            .thumbColor(R.color.colorAccent)
            .thumbSize(14)
            .trackProgressColor(R.color.colorAccent)
            .trackProgressSize(4)
            .trackBackgroundColor(R.color.ash_dark)
...
//            holder.adapterSubCategoryAdapterBinding.seekbar1.
//
