...
import com.apollopharmacy.vishwam.databinding.RiderFragmentDashboardBinding;
import com.apollopharmacy.vishwam.ui.home.MainActivity;
import com.apollopharmacy.vishwam.ui.rider.activity.NewOrderActivity;
...
import com.apollopharmacy.vishwam.util.XYMarkerView;
...
public class DashboardFragment extends BaseFragment implements DashboardFragmentCallback, OnChartValueSelectedListener, GoogleApiClient.ConnectionCallbacks,
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        dashboardBinding = DataBindingUtil.inflate(inflater, R.layout.rider_fragment_dashboard, container, false);
...
//        NavigationActivity.getInstance().setTitle(R.string.menu_dashboard);
        ...
        if (Utils.NOTIFICATIONS_COUNT == 0)
        ...
        if (getSessionManager().getNotificationStatus()) {
            ...
            dashboardBinding.newOrder.setText(Utils.NOTIFICATIONS_COUNT == 1 ? "1 New Order" : Utils.NOTIFICATIONS_COUNT + " New Orders");
...
//        travelledDistanceVal.setText("110.4 KM");
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        newOrderLayout.setOnClickListener(v -> {
            ...
            MainActivity.mInstance.displaySelectedScreen("My Orders");
...
//        Log.i(TAG, "Building GoogleApiClient");
    ...
    public void onSuccessGetProfileDetailsApi(GetRiderProfileResponse getRiderProfileResponse) {
        if (getRiderProfileResponse != null) {
           ...
           MainActivity.mInstance.setProfileData();
...
//            todayRiderTravelledDistanceText();
    ...
    public void onClickCodReciebedorPendingDeposits() {
        MainActivity.mInstance.displaySelectedScreen("Cash Deposits");
...
//        NavigationActivity.getInstance().selectItem(1);
    ...
    public void onClickIntransitOrders() {
        Utils.selectedTab = "INTRANSIT";
        MainActivity.mInstance.displaySelectedScreen("My Orders");
    }

    @Override
    public void onClickDeliveredOrders() {
        Utils.selectedTab = "DELIVERED";
        MainActivity.mInstance.displaySelectedScreen("My Orders");
    }

    @Override
    public void onClickCancelledOrders() {
        Utils.selectedTab = "CANCELLED";
        MainActivity.mInstance.displaySelectedScreen("My Orders");
    }
    ...
    public static void newOrderViewVisibility(boolean show) {
        try {
            if (show) {
                ...
                newOrder.setText(Utils.NOTIFICATIONS_COUNT == 1 ? "1 New Order" : +Utils.NOTIFICATIONS_COUNT + " New Orders");
                timeView.setText(Utlis.INSTANCE.getTimeFormatter(orderDateMills));
            } else {
