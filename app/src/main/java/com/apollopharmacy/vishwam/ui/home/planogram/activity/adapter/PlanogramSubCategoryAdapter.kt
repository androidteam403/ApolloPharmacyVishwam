...
//         if (detailsListResponse.data!!.diaperPodium != null) {
//                for (j in detailsListResponse.data!!.diaperPodium!!.indices) {
//                    if (detailsListResponse.data!!.diaperPodium!!.get(j).offerTentCard!!.uid != null) {
//
//
//                        if (detailsListResponse.data!!.diaperPodium!!.get(j).offerTentCard!!.name!!.uppercase()
//                                .equals("Y")
//                        ) {
//                            holder.adapterPlanogramSubCategoryBinding.progressName.text = "YES"
//
...
//                                applicationContext.resources.getColor(R.color.greenY)
//                            )
//                        } else if (detailsListResponse.data!!.diaperPodium!!.get(j).offerTentCard!!.name!!.uppercase()
//                                .equals("N")
//                        ) {
//                            holder.adapterPlanogramSubCategoryBinding.progressName.text = "NO"
//
...
//                    }
//
//                    if (detailsListResponse.data!!.diaperPodium!!.get(j).allBrandsDisplay!!.uid != null) {
//
//                        if (detailsListResponse.data!!.diaperPodium!!.get(j).allBrandsDisplay!!.name!!.uppercase()
//                                .equals("Y")
//                        ) {
//                            holder.adapterPlanogramSubCategoryBinding.progressName.text = "YES"
//
...
//                                applicationContext.resources.getColor(R.color.greenY)
//                            )
//                        } else if (detailsListResponse.data!!.diaperPodium!!.get(j).allBrandsDisplay!!.name!!.uppercase()
//                                .equals("NA")
//                        ) {
//
//                            holder.adapterPlanogramSubCategoryBinding.noLayout.background =
...
//            if (detailsListResponse.data!!.valueDealsBin != null) {
//                for (j in detailsListResponse.data!!.valueDealsBin!!.indices) {
//                    if (detailsListResponse.data!!.valueDealsBin!!.get(j).fillUptoTop!!.uid != null) {
//                        if (detailsListResponse.data!!.valueDealsBin!!.get(j).fillUptoTop!!.name!!.uppercase()
//                                .equals("Y")
//                        ) {
//                            holder.adapterPlanogramSubCategoryBinding.progressName.text = "YES"
//
...
//                                applicationContext.resources.getColor(R.color.greenY)
//                            )
//                        } else if (detailsListResponse.data!!.valueDealsBin!!.get(j).fillUptoTop!!.name!!.uppercase()
//                                .equals("NA")
//                        ) {
//
//                            holder.adapterPlanogramSubCategoryBinding.noLayout.background =
...
//                    }
//
//                    if (detailsListResponse.data!!.valueDealsBin!!.get(j).groupedProductWise!!.uid != null) {
//
//                        if (detailsListResponse.data!!.valueDealsBin!!.get(j).groupedProductWise!!.name!!.uppercase()
//                                .equals("Y")
//                        ) {
//                            holder.adapterPlanogramSubCategoryBinding.progressName.text = "YES"
//
...
//                                applicationContext.resources.getColor(R.color.greenY)
//                            )
//                        } else if (detailsListResponse.data!!.valueDealsBin!!.get(j).groupedProductWise!!.name!!.uppercase()
//                                .equals("N")
//                        ) {
//                            holder.adapterPlanogramSubCategoryBinding.progressName.text = "NO"
//
...
//            if (detailsListResponse.data!!.posters != null) {
//                for (j in detailsListResponse.data!!.posters!!.indices) {
//                    if (detailsListResponse.data!!.posters!!.get(j).monthlyOffers!!.uid != null) {
//                        if (detailsListResponse.data!!.posters!!.get(j).monthlyOffers!!.name!!.uppercase()
//                                .equals("Y")
//                        ) {
//                            holder.adapterPlanogramSubCategoryBinding.progressName.text = "YES"
//
...
//                                applicationContext.resources.getColor(R.color.greenY)
//                            )
//                        } else if (detailsListResponse.data!!.posters!!.get(j).monthlyOffers!!.name!!.uppercase()
//                                .equals("N")
//                        ) {
//                            holder.adapterPlanogramSubCategoryBinding.progressName.text = "NO"
//
...
//                    }
//
//                    if (detailsListResponse.data!!.posters!!.get(j).smartSaveOffer!!.uid != null) {
//
//                        if (detailsListResponse.data!!.posters!!.get(j).smartSaveOffer!!.name!!.uppercase()
//                                .equals("Y")
//                        ) {
//                            holder.adapterPlanogramSubCategoryBinding.progressName.text = "YES"
//
...
//                                applicationContext.resources.getColor(R.color.greenY)
//                            )
//                        } else if (detailsListResponse.data!!.posters!!.get(j).smartSaveOffer!!.name!!.uppercase()
//                                .equals("N")
//                        ) {
//                            holder.adapterPlanogramSubCategoryBinding.progressName.text = "NO"
//
...
//
//
//                    if (detailsListResponse.data!!.posters!!.get(j).noUnauthOldPosters!!.uid != null) {
//
//                        if (detailsListResponse.data!!.posters!!.get(j).noUnauthOldPosters!!.name!!.uppercase()
//                                .equals("Y")
//                        ) {
//                            holder.adapterPlanogramSubCategoryBinding.progressName.text = "YES"
//
...
//                                applicationContext.resources.getColor(R.color.greenY)
//                            )
//                        } else if (detailsListResponse.data!!.posters!!.get(j).noUnauthOldPosters!!.name!!.uppercase()
//                                .equals("N")
//                        ) {
//                            holder.adapterPlanogramSubCategoryBinding.progressName.text = "NO"
//
...
//            if (detailsListResponse.data!!.peghooksDisplay != null) {
//                for (j in detailsListResponse.data!!.peghooksDisplay!!.indices) {
//                    if (detailsListResponse.data!!.peghooksDisplay!!.get(j).groupedProductWise!!.uid != null) {
//
//                        if (detailsListResponse.data!!.peghooksDisplay!!.get(j).groupedProductWise!!.name!!.uppercase()
//                                .equals("Y")
//                        ) {
//                            holder.adapterPlanogramSubCategoryBinding.progressName.text = "YES"
//
...
//                                applicationContext.resources.getColor(R.color.greenY)
//                            )
//                        } else if (detailsListResponse.data!!.peghooksDisplay!!.get(j).groupedProductWise!!.name!!.uppercase()
//                                .equals("N")
//                        ) {
//                            holder.adapterPlanogramSubCategoryBinding.progressName.text = "NO"
//
...
//                        }
//                    }
//                    if (detailsListResponse.data!!.peghooksDisplay!!.get(j).customerFacing!!.uid != null) {
//
//                        if (detailsListResponse.data!!.peghooksDisplay!!.get(j).customerFacing!!.name!!.uppercase()
//                                .equals("Y")
//                        ) {
//                            holder.adapterPlanogramSubCategoryBinding.progressName.text = "YES"
//
...
//                                applicationContext.resources.getColor(R.color.greenY)
//                            )
//                        } else if (detailsListResponse.data!!.peghooksDisplay!!.get(j).customerFacing!!.name!!.uppercase()
//                                .equals("NA")
//                        ) {
//                            holder.adapterPlanogramSubCategoryBinding.noLayout.background =
//                                applicationContext.getDrawable(R.drawable.bg_na_no_plano)
...
//            if (detailsListResponse.data!!.offersGondola != null) {
//                for (j in detailsListResponse.data!!.offersGondola!!.indices) {
//                    if (detailsListResponse.data!!.offersGondola!!.get(j).shelfFacing!!.uid != null) {
//
//                        if (detailsListResponse.data!!.offersGondola!!.get(j).shelfFacing!!.name!!.uppercase()
//                                .equals("Y")
//                        ) {
//                            holder.adapterPlanogramSubCategoryBinding.progressName.text = "YES"
//
...
//                                applicationContext.resources.getColor(R.color.greenY)
//                            )
//                        } else if (detailsListResponse.data!!.offersGondola!!.get(j).shelfFacing!!.name!!.uppercase()
//                                .equals("N")
//                        ) {
//                            holder.adapterPlanogramSubCategoryBinding.progressName.text = "NO"
//
...
//
//
//                    if (detailsListResponse.data!!.offersGondola!!.get(j).correctOfferTalkers!!.uid != null) {
//
//                        if (detailsListResponse.data!!.offersGondola!!.get(j).correctOfferTalkers!!.name!!.uppercase()
//                                .equals("Y")
//                        ) {
//                            holder.adapterPlanogramSubCategoryBinding.progressName.text = "YES"
//
...
//                                applicationContext.resources.getColor(R.color.greenY)
//                            )
//                        } else if (detailsListResponse.data!!.offersGondola!!.get(j).correctOfferTalkers!!.name!!.uppercase()
//                                .equals("N")
//                        ) {
//                            holder.adapterPlanogramSubCategoryBinding.progressName.text = "NO"
//
...
//            if (detailsListResponse.data!!.chiller != null) {
//                for (j in detailsListResponse.data!!.chiller!!.indices) {
//                    if (detailsListResponse.data!!.chiller!!.get(j).shelfFacing!!.uid != null) {
//
//                        if (detailsListResponse.data!!.chiller!!.get(j).shelfFacing!!.name!!.uppercase()
//                                .equals("Y")
//                        ) {
//                            holder.adapterPlanogramSubCategoryBinding.progressName.text = "YES"
//
...
//                                applicationContext.resources.getColor(R.color.greenY)
//                            )
//                        } else if (detailsListResponse.data!!.chiller!!.get(j).shelfFacing!!.name!!.uppercase()
//                                .equals("N")
//                        ) {
//                            holder.adapterPlanogramSubCategoryBinding.progressName.text = "NO"
//
...
//
//                    }
//                    if (detailsListResponse.data!!.chiller!!.get(j).groupedProductWise!!.uid != null) {
//
//                        if (detailsListResponse.data!!.chiller!!.get(j).groupedProductWise!!.name!!.uppercase()
//                                .equals("Y")
//                        ) {
//                            holder.adapterPlanogramSubCategoryBinding.progressName.text = "YES"
//
...
//                                applicationContext.resources.getColor(R.color.greenY)
//                            )
//                        } else if (detailsListResponse.data!!.chiller!!.get(j).groupedProductWise!!.name!!.uppercase()
//                                .equals("NA")
//                        ) {
//                            holder.adapterPlanogramSubCategoryBinding.noLayout.background =
//                                applicationContext.getDrawable(R.drawable.bg_na_no_plano)
...
//                        }
//                    }
//                    if (detailsListResponse.data!!.chiller!!.get(j).noGaps!!.uid != null) {
//
//                        if (detailsListResponse.data!!.chiller!!.get(j).noGaps!!.name!!.uppercase()
//                                .equals("Y")
//                        ) {
//                            holder.adapterPlanogramSubCategoryBinding.progressName.text = "YES"
//
...
//                                applicationContext.resources.getColor(R.color.greenY)
//                            )
//                        } else if (detailsListResponse.data!!.chiller!!.get(j).noGaps!!.name!!.uppercase()
//                                .equals("NA")
//                        ) {
//                            holder.adapterPlanogramSubCategoryBinding.noLayout.background =
//                                applicationContext.getDrawable(R.drawable.bg_na_no_plano)
...
//
//            }
//    if (detailsListResponse.data!!.planogramSurvey != null) {
//
//        for (i in detailsListResponse.data!!.planogramSurvey!!.indices) {
//            if (detailsListResponse.data!!.planogramSurvey!!.get(i).categoryType!!.uid != null) {
//                if (categoryName.equals(detailsListResponse.data!!.planogramSurvey!!.get(i).categoryType!!.name)) {
//
//                    if (detailsListResponse.data!!.planogramSurvey!!.get(i).cleanliness!!.name!!.uppercase()
//                            .equals("Y")
//                    ) {
//                        holder.adapterPlanogramSubCategoryBinding.progressName.text = "YES"
//
...
//                            applicationContext.resources.getColor(R.color.greenY)
//                        )
//                    } else if (detailsListResponse.data!!.planogramSurvey!!.get(i).cleanliness!!.name!!.uppercase()
//                            .equals("N")
//                    ) {
//                        holder.adapterPlanogramSubCategoryBinding.progressName.text = "NO"
//
...
//                }
//
//                if (detailsListResponse.data!!.planogramSurvey!!.get(i).subcatFlow != null) {
//                    if (detailsListResponse.data!!.planogramSurvey!!.get(i).subcatFlow!!.name!!.uppercase()
//                            .equals("Y")
//                    ) {
//                        holder.adapterPlanogramSubCategoryBinding.progressName.text = "YES"
//
...
//                            applicationContext.resources.getColor(R.color.greenY)
//                        )
//                    } else if (detailsListResponse.data!!.planogramSurvey!!.get(i).subcatFlow!!.name!!.uppercase()
//                            .equals("NA")
//                    ) {
//                        holder.adapterPlanogramSubCategoryBinding.noLayout.background =
//                            applicationContext.getDrawable(R.drawable.bg_na_no_plano)
...
//
//
//                if (detailsListResponse.data!!.planogramSurvey!!.get(i).lftRightFrntBck!!.name!!.uppercase()
//                        .equals("Y")
//                ) {
//                    holder.adapterPlanogramSubCategoryBinding.progressName.text = "YES"
//
...
//                        applicationContext.resources.getColor(R.color.greenY)
//                    )
//                } else if (detailsListResponse.data!!.planogramSurvey!!.get(i).lftRightFrntBck!!.name!!.uppercase()
//                        .equals("NA")
//                ) {
//                    holder.adapterPlanogramSubCategoryBinding.noLayout.background =
//                        applicationContext.getDrawable(R.drawable.bg_na_no_plano)
...
//                }
//
//                if (detailsListResponse.data!!.planogramSurvey!!.get(i).shelfFacing!!.name!!.uppercase()
//                        .equals("Y")
//                ) {
//                    holder.adapterPlanogramSubCategoryBinding.progressName.text = "YES"
//
...
//                        applicationContext.resources.getColor(R.color.greenY)
//                    )
//                } else if (detailsListResponse.data!!.planogramSurvey!!.get(i).shelfFacing!!.name!!.uppercase()
//                        .equals("NA")
//                ) {
//                    holder.adapterPlanogramSubCategoryBinding.noLayout.background =
//                        applicationContext.getDrawable(R.drawable.bg_na_no_plano)
...
//                    )
//                }
//                if (detailsListResponse.data!!.planogramSurvey!!.get(i).shelfStrips!!.name!!.uppercase()
//                        .equals("Y")
//                ) {
//                    holder.adapterPlanogramSubCategoryBinding.progressName.text = "YES"
//
...
//                        applicationContext.resources.getColor(R.color.greenY)
//                    )
//                } else if (detailsListResponse.data!!.planogramSurvey!!.get(i).shelfStrips!!.name!!.uppercase()
//                        .equals("NA")
//                ) {
//                    holder.adapterPlanogramSubCategoryBinding.noLayout.background =
//                        applicationContext.getDrawable(R.drawable.bg_na_no_plano)
...
//                    )
//                }
//                if (detailsListResponse.data!!.planogramSurvey!!.get(i).condTagOffTalkers!!.name!!.uppercase()
//                        .equals("Y")
//                ) {
//                    holder.adapterPlanogramSubCategoryBinding.progressName.text = "YES"
//
...
//                        applicationContext.resources.getColor(R.color.greenY)
//                    )
//                } else if (detailsListResponse.data!!.planogramSurvey!!.get(i).condTagOffTalkers!!.name!!.uppercase()
//                        .equals("NA")
//                ) {
//                    holder.adapterPlanogramSubCategoryBinding.noLayout.background =
//                        applicationContext.getDrawable(R.drawable.bg_na_no_plano)
...
//                    )
//                }
//                if (detailsListResponse.data!!.planogramSurvey!!.get(i).fifo!!.name!!.uppercase()
//                        .equals("Y")
//                ) {
//                    holder.adapterPlanogramSubCategoryBinding.progressName.text = "YES"
//
...
//                        applicationContext.resources.getColor(R.color.greenY)
//                    )
//                } else if (detailsListResponse.data!!.planogramSurvey!!.get(i).fifo!!.name!!.uppercase()
//                        .equals("NA")
//                ) {
//                    holder.adapterPlanogramSubCategoryBinding.noLayout.background =
//                        applicationContext.getDrawable(R.drawable.bg_na_no_plano)
...
//                    )
//                }
//                if (detailsListResponse.data!!.planogramSurvey!!.get(i).emptyShelvesRefill!!.name!!.uppercase()
//                        .equals("Y")
//                ) {
//                    holder.adapterPlanogramSubCategoryBinding.progressName.text = "YES"
//
...
//                        applicationContext.resources.getColor(R.color.greenY)
//                    )
//                } else if (detailsListResponse.data!!.planogramSurvey!!.get(i).emptyShelvesRefill!!.name!!.uppercase()
//                        .equals("NA")
//                ) {
//                    holder.adapterPlanogramSubCategoryBinding.noLayout.background =
//                        applicationContext.getDrawable(R.drawable.bg_na_no_plano)
