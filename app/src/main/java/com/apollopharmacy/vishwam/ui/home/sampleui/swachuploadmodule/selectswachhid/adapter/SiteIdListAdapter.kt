package com.apollopharmacy.vishwam.ui.home.sampleui.swachuploadmodule.selectswachhid.adapter
...
import com.apollopharmacy.vishwam.ui.home.sampleui.swachuploadmodule.selectswachhid.SelectSwachhSiteIdCallback

class SiteIdListAdapter(
    val applicationContext: Context,
    var siteData: ArrayList<StoreListItem>,
    val selectSiteIdCallback: SelectSwachhSiteIdCallback,
) :
    RecyclerView.Adapter<SiteIdListAdapter.ViewHolder>() {

    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int,
    ): SiteIdListAdapter.ViewHolder {
        ...
        return SiteIdListAdapter.ViewHolder(adapterSwachhSiteidListBinding)
    }


    override fun onBindViewHolder(holder: SiteIdListAdapter.ViewHolder, position: Int) {
