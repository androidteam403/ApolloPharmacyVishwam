package com.apollopharmacy.vishwam.ui.rider.summary.adapter;
...
import com.apollopharmacy.vishwam.databinding.AdapterSummaryBinding;
...
public class SummaryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ITEM) {
            ...
            return new ItemViewHolder(summaryBinding);
        } else {
...
//        holder.summaryBinding.dividerViewFour.setBackgroundColor(context.getColor(R.color.order_item_divider_color));
        try {
            ...
            long orderDateMills = orderDates.getTime();
            holder.summaryBinding.deliverBy.setText(Utlis.INSTANCE.getTimeFormatter(orderDateMills));
