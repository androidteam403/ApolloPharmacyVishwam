package com.apollopharmacy.vishwam.ui.home.apnarectro.prerectro.filter.adapter
...
import com.apollopharmacy.vishwam.ui.home.apnarectro.prerectro.filter.SelectRectroSiteCallback
import com.apollopharmacy.vishwam.ui.home.swach.swachuploadmodule.selectswachhid.SelectSwachhSiteIdCallback

class SiteIdAdapterRectro(
    val applicationContext: Context,
    var siteData: ArrayList<StoreListItem>,
    val selectSiteIdCallback: SelectRectroSiteCallback,
) :
    RecyclerView.Adapter<SiteIdAdapterRectro.ViewHolder>() {

    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int,
    ): SiteIdAdapterRectro.ViewHolder {
        ...
        return SiteIdAdapterRectro.ViewHolder(adapterSwachhSiteidListBinding)
    }


    override fun onBindViewHolder(holder: SiteIdAdapterRectro.ViewHolder, position: Int) {
