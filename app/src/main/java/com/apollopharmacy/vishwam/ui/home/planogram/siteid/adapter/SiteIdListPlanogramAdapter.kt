package com.apollopharmacy.vishwam.ui.home.planogram.siteid.adapter
...
class SiteIdListPlanogramAdapter(
    val applicationContext: Context,
    var siteData: ArrayList<StoreDetailsModelResponse.Row>,
    val selectSiteIdCallback: SelectPlanogramSiteIdCallback,
) :
    RecyclerView.Adapter<SiteIdListPlanogramAdapter.ViewHolder>() {
