package com.apollopharmacy.vishwam.ui.sampleui.swachuploadmodule.sampleswachui.adapter
...
class GetStorePersonAdapter(
    ...
    interface getStoreHistory {
        fun onClickStatus(position: Int, swachhid: String?, status: String?)
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.overAllLayout.setOnClickListener {
            callBackInterface.onClickStatus(position, getStorePerson?.swachhid, getStorePerson?.status)
        }
