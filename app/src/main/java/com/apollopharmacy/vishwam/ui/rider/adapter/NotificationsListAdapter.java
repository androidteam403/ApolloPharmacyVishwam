package com.apollopharmacy.vishwam.ui.rider.adapter;
...
import com.apollopharmacy.vishwam.ui.rider.model.NotificationItemModel;
import com.apollopharmacy.vishwam.ui.rider.notifications.OnItemClickListener;
...
public class NotificationsListAdapter extends RecyclerView.Adapter<NotificationsListAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_notification_items, parent, false);
