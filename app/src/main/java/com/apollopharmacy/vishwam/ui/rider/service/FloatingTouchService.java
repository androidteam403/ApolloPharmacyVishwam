...
import static com.apollopharmacy.vishwam.util.signaturepad.ActivityUtils.isAppOnForeground;
...
//        mAssistiveTouchView.setVisibility(View.GONE);
    ...
    private void calculateForMyPhone() {
        DisplayMetrics displayMetrics = Utlis.INSTANCE.getScreenSize(this);
        mScreenWidth = displayMetrics.widthPixels;
        mScreenHeight = displayMetrics.heightPixels;
        mStatusBarHeight = Utlis.INSTANCE.getStatusBarHeight(this);
    }
...
//                updateAssistiveInvisible();
                    ...
                    try {
//                        if (Utlis.INSTANCE.CURRENT_SCREEN.equals(NavigationActivity.class.getSimpleName())) {
//                            Intent intent = new Intent(getApplicationContext(), NavigationActivity.class);
//                            intent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT
//                                    | Intent.FLAG_ACTIVITY_NEW_TASK
//                                    | Intent.FLAG_ACTIVITY_SINGLE_TOP);
//                            startActivity(intent);
//                        } else if (Utlis.INSTANCE.CURRENT_SCREEN.equals(ReportsActivity.class.getSimpleName())) {
//                            Intent intent = new Intent(getApplicationContext(), ReportsActivity.class);
//                            intent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT
//                                    | Intent.FLAG_ACTIVITY_NEW_TASK
//                                    | Intent.FLAG_ACTIVITY_SINGLE_TOP);
//                            startActivity(intent);
//                        } else if (Utlis.INSTANCE.CURRENT_SCREEN.equals(OrderDeliveryActivity.class.getSimpleName())) {
//                            Intent intent = new Intent(getApplicationContext(), OrderDeliveryActivity.class);
//                            intent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT
//                                    | Intent.FLAG_ACTIVITY_NEW_TASK
//                                    | Intent.FLAG_ACTIVITY_SINGLE_TOP);
//                            startActivity(intent);
//                        } else if (Utlis.INSTANCE.CURRENT_SCREEN.equals(TrackMapActivity.class.getSimpleName())) {
//                            Intent intent = new Intent(getApplicationContext(), TrackMapActivity.class);
//                            intent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT
//                                    | Intent.FLAG_ACTIVITY_NEW_TASK
//                                    | Intent.FLAG_ACTIVITY_SINGLE_TOP);
//                            startActivity(intent);
//                        } else if (Utlis.INSTANCE.CURRENT_SCREEN.equals(CaptureSignatureActivity.class.getSimpleName())) {
