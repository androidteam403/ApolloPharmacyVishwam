...
class HomeViewModel : ViewModel() {
    ...
    /*fun test(callback: HomeFragmentCallback) {
        ...
        var baseUrl =
            "https://live.machs.edu.sa/zc-v3.1-user-svc-boot/2.0/machs/zc-setting" //"https://live.machs.edu.sa/zc-v3.1-user-svc-boot/2.0/machs/general?data=hi"//""https://apis.v35.dev.zeroco.de/zc-v3.1-user-svc/2.0/machs/zc-setting"//"https://live.machs.edu.sa/zc-v3.1-user-svc-boot/2.0/machs/general?data=hi"//"https://live.machs.edu.sa/zc-v3.1-user-svc-boot/2.0/machs/zc-setting"
        var token = ""
