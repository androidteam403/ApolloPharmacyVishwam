...
import com.apollopharmacy.vishwam.databinding.ActivityCaptureSignatureBinding;
import com.apollopharmacy.vishwam.ui.rider.service.FloatingTouchService;
import com.apollopharmacy.vishwam.ui.rider.signature.SignatureView;
...
//                path = saveImage(bitmap);
    ...
    protected void onResume() {
        super.onResume();
        AppConstants.CURRENT_SCREEN = getClass().getSimpleName();
