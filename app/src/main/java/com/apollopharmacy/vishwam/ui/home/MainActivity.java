...
//                            .addChildModel(new ChildModel("Approval List", R.drawable.ic_apollo_complaint_list))
        ...
        if (true) {
            ...
            if (getSessionManager().getLoginToken().isEmpty()) {
                ...
                listView.addHeaderModel(new HeaderModel("Vivekagam", Color.WHITE, true, R.drawable.ic_untitled_1).addChildModel(new ChildModel("Dashboard", R.drawable.ic_apollo_dashboard)).addChildModel(new ChildModel("My Orders", R.drawable.ic_apollo_list2)).addChildModel(new ChildModel("Cash Deposits", R.drawable.ic_apollo_bill)).addChildModel(new ChildModel("Summary", R.drawable.ic_apollo_survey_68__1_)).addChildModel(new ChildModel("Complaints", R.drawable.ic_apollo_complaint_list)).addChildModel(new ChildModel("Profile", R.drawable.ic_apollo_survey_admin)).addChildModel(new ChildModel("Change Password", R.drawable.ic_apollo_complaint_register)).addChildModel(new ChildModel("Help", R.drawable.ic_apollo_new_drug_request__1_))
