...
import com.apollopharmacy.vishwam.databinding.AdapterOrdersCodStatusBinding;
...
import com.apollopharmacy.vishwam.ui.rider.reports.ReportsFragmentCallback;
    ...
    private void itemOnBindViewHolder(@NonNull ItemViewHolder holder, int position) {
        try {
            ...
            if (orderCodStatus.getOrderRider().getDeliveredOn() != null && !orderCodStatus.getOrderRider().getDeliveredOn().isEmpty()) {
                ...
                holder.ordersCodStatusBinding.deliveredDate.setText(Utlis.INSTANCE.getTimeFormatter(orderDateMills));
            } else {
