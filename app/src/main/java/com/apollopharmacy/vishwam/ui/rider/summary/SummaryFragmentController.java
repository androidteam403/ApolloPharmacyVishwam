...
public class SummaryFragmentController {
    ...
    public void myOrdersListApiCall(int page) {
        if (NetworkUtils.isNetworkConnected(mContext)) {
            ...
            getDetailsRequest.setRequesturl(AppConstants.BASE_URL + "api/orders/list/my-order-list"+"?"+"page="+page+"&"+"rows="+"10"+"&"+"from_date="+mListener.fromDate()+"&"+"to_date="+mListener.toDate());
