...
//            if (regionId.isNotEmpty() && siteId.isEmpty()) {
...
//                }
//            }
//            if (siteId.isNotEmpty() && regionId.isEmpty()) {
...
//
//            //date filter
//            else if (storeIdList.isEmpty() && siteId.isNotEmpty() && fromDate.isNotEmpty() && currentDate.isNotEmpty()) {
//
//                for (i in pendinglist.indices) {
//                    var omsOrderno = pendinglist.get(i).omsorderno!!.toUpperCase()
//                    var site = pendinglist.get(i).storeid!!.toUpperCase()
//                    var region = pendinglist.get(i).dcCode
//                    var reqDate = formatQcdate(pendinglist.get(i).requesteddate!!)
//
//
//                    if (site.contains(siteId) && (Utlis.filterDateFormate(fromDate)
//                            .before(Utlis.filterDateFormate(reqDate))) && (Utlis.filterDateFormate(
//                            currentDate
//                    ).after(Utlis.filterDateFormate(reqDate))) || (Utlis.filterDateFormate(fromDate)
//                            .equals(Utlis.filterDateFormate(reqDate))) || (Utlis.filterDateFormate(
//                            currentDate
//                    ).equals(Utlis.filterDateFormate(reqDate)))
//                    ) {
//                        orderTypeFilteredPendinglist.add(pendinglist.get(i))
//                    }
//
//                }
//                return orderTypeFilteredPendinglist
//            } else if (regionIdList.isEmpty() && regionId.isNotEmpty() && siteId.isEmpty() && fromDate.isNotEmpty() && currentDate.isNotEmpty()) {
//
//                for (i in pendinglist.indices) {
//                    var omsOrderno = pendinglist.get(i).omsorderno!!.toUpperCase()
//                    var site = pendinglist.get(i).storeid!!.toUpperCase()
...
//
//
//                    if (region!!.contains(regionId) && (Utlis.filterDateFormate(fromDate)
//                            .before(Utlis.filterDateFormate(reqDate))) && (Utlis.filterDateFormate(
//                            currentDate
//                    ).after(Utlis.filterDateFormate(reqDate))) || (Utlis.filterDateFormate(fromDate)
//                            .equals(Utlis.filterDateFormate(reqDate))) || (Utlis.filterDateFormate(
...
//                }
//                return orderTypeFilteredPendinglist
//            } else if (typeString.isNotEmpty() && regionId.isEmpty() && siteId.isEmpty() && fromDate.isNotEmpty() && currentDate.isNotEmpty()) {
//
//                for (i in pendinglist.indices) {
//                    var omsOrderno = pendinglist.get(i).omsorderno!!.toUpperCase()
//                    var site = pendinglist.get(i).storeid!!.toUpperCase()
...
//
//
//                    if (typeString.equals("FORWARD RETURN") && omsOrderno.contains("FL") && (Utlis.filterDateFormate(
//                            fromDate
//                    ).before(Utlis.filterDateFormate(reqDate))) && (Utlis.filterDateFormate(
//                            currentDate
//                    ).after(Utlis.filterDateFormate(reqDate))) || (Utlis.filterDateFormate(fromDate)
...
//                    ) {
//                        orderTypeFilteredPendinglist.add(pendinglist.get(i))
//                    } else if (typeString.equals("REVERSE RETURN") && omsOrderno.contains("RT") && (Utlis.filterDateFormate(
//                            fromDate
//                    ).before(Utlis.filterDateFormate(reqDate))) && (Utlis.filterDateFormate(
//                            currentDate
//                    ).after(Utlis.filterDateFormate(reqDate))) || (Utlis.filterDateFormate(fromDate)
...
//                }
//                return orderTypeFilteredPendinglist
//            } else if (regionIdList.isEmpty() && regionId.isEmpty() && siteId.isEmpty() && fromDate.isNotEmpty() && currentDate.isEmpty()) {
//
//                for (i in pendinglist.indices) {
//                    var omsOrderno = pendinglist.get(i).omsorderno!!.toUpperCase()
//                    var site = pendinglist.get(i).storeid!!.toUpperCase()
...
//
//
//                    if ((Utlis.filterDateFormate(fromDate).equals(Utlis.filterDateFormate(reqDate)))) {
//                        orderTypeFilteredPendinglist.add(pendinglist.get(i))
//                    }
//
//                }
//                return orderTypeFilteredPendinglist
//            } else if (regionIdList.isEmpty() && regionId.isEmpty() && siteId.isEmpty() && fromDate.isEmpty() && currentDate.isNotEmpty()) {
//
//                for (i in pendinglist.indices) {
//                    var omsOrderno = pendinglist.get(i).omsorderno!!.toUpperCase()
//                    var site = pendinglist.get(i).storeid!!.toUpperCase()
...
//
//
//                    if ((Utlis.filterDateFormate(currentDate)
//                            .equals(Utlis.filterDateFormate(reqDate)))
//                    ) {
//                        orderTypeFilteredPendinglist.add(pendinglist.get(i))
//                    }
...
//                }
//                return orderTypeFilteredPendinglist
//            } else if (typeString.isNotEmpty() && regionId.isNotEmpty() && siteId.isNotEmpty() && fromDate.isNotEmpty() && currentDate.isNotEmpty()) {
//
//                for (i in pendinglist.indices) {
//                    var omsOrderno = pendinglist.get(i).omsorderno!!.toUpperCase()
//                    var site = pendinglist.get(i).storeid!!.toUpperCase()
...
//
//
//                    if (site.contains(siteId) && region!!.contains(regionId) && typeString.equals("FORWARD RETURN") && omsOrderno.contains(
//                            "FL"
//                    ) && (Utlis.filterDateFormate(fromDate)
//                            .before(Utlis.filterDateFormate(reqDate))) && (Utlis.filterDateFormate(
//                            currentDate
//                    ).after(Utlis.filterDateFormate(reqDate))) || (Utlis.filterDateFormate(fromDate)
//                            .equals(Utlis.filterDateFormate(reqDate))) || (Utlis.filterDateFormate(
...
//                ) {
//                        orderTypeFilteredPendinglist.add(pendinglist.get(i))
//                    } else if (site.contains(siteId) && region!!.contains(regionId) && typeString.equals(
//                            "REVERSE RETURN"
//                    ) && omsOrderno.contains("RT") && (Utlis.filterDateFormate(fromDate)
//                            .before(Utlis.filterDateFormate(reqDate))) && (Utlis.filterDateFormate(
//                            currentDate
//                    ).after(Utlis.filterDateFormate(reqDate))) || (Utlis.filterDateFormate(fromDate)
//                            .equals(Utlis.filterDateFormate(reqDate))) || (Utlis.filterDateFormate(
...
//                }
//                return orderTypeFilteredPendinglist
//            } else if (typeString.isNotEmpty() && storeIdList.size > 1 && regionIdList.size > 1 && fromDate.isNotEmpty() && currentDate.isNotEmpty()) {
//                for (i in pendinglist) {
//                    var omsOrderno = i.omsorderno!!.toUpperCase()
//                    var site = i.storeid!!.toUpperCase()
//                    var region = i.dcCode
//                    var reqDate = formatQcdate(i.requesteddate!!)
//
...
//                                    storeIdList.get(j)
//                            ) && region!!.contains(regionIdList.get(k)) && (Utlis.filterDateFormate(
//                                    fromDate
//                            ).before(Utlis.filterDateFormate(reqDate))) && (Utlis.filterDateFormate(
//                                    currentDate
//                            ).after(Utlis.filterDateFormate(reqDate))) || (Utlis.filterDateFormate(
//                                    fromDate
//                            ).equals(Utlis.filterDateFormate(reqDate))) || (Utlis.filterDateFormate(
//                                    currentDate
//                            ).equals(Utlis.filterDateFormate(reqDate)))
...
//                }
//                return orderTypeFilteredPendinglist
//            } else if (regionIdList.size > 1 && typeString.isEmpty() && siteId.isEmpty() && fromDate.isNotEmpty() && currentDate.isNotEmpty()) {
//
//                for (i in pendinglist) {
//                    var omsOrderno = i.omsorderno!!.toUpperCase()
//                    var site = i.storeid!!.toUpperCase()
...
//
//
//                        if (region!!.contains(regionIdList.get(j)) && (Utlis.filterDateFormate(fromDate)
//                                .before(Utlis.filterDateFormate(reqDate))) && (Utlis.filterDateFormate(
//                                currentDate
//                        ).after(Utlis.filterDateFormate(reqDate))) || (Utlis.filterDateFormate(
//                                fromDate
...
//                }
//                return orderTypeFilteredPendinglist
//            } else if (siteId.isNotEmpty() && storeIdList.size > 1 && typeString.isEmpty() && regionId.isEmpty() && fromDate.isNotEmpty() && currentDate.isNotEmpty()) {
//
//                for (i in pendinglist) {
//                    var omsOrderno = i.omsorderno!!.toUpperCase()
//                    var site = i.storeid!!.toUpperCase()
...
//
//
//                        if (site.contains(storeIdList.get(j)) && (Utlis.filterDateFormate(fromDate)
//                                .before(Utlis.filterDateFormate(reqDate))) && (Utlis.filterDateFormate(
//                                currentDate
//                        ).after(Utlis.filterDateFormate(reqDate))) || (Utlis.filterDateFormate(
//                                fromDate
...
//                }
//                return orderTypeFilteredPendinglist
//            } else if (typeString.isEmpty() && regionId.isNotEmpty() && siteId.isNotEmpty() && fromDate.isNotEmpty() && currentDate.isNotEmpty()) {
//
//                for (i in pendinglist.indices) {
//                    var omsOrderno = pendinglist.get(i).omsorderno!!.toUpperCase()
//                    var site = pendinglist.get(i).storeid!!.toUpperCase()
...
//
//
//                    if (site.contains(siteId) && region!!.contains(regionId) && (Utlis.filterDateFormate(
//                            fromDate
//                    ).before(Utlis.filterDateFormate(reqDate))) && (Utlis.filterDateFormate(
//                            currentDate
//                    ).after(Utlis.filterDateFormate(reqDate))) || (Utlis.filterDateFormate(fromDate)
...
//                }
//                return orderTypeFilteredPendinglist
//            } else if (typeString.isNotEmpty() && regionId.isEmpty() && siteId.isNotEmpty() && fromDate.isNotEmpty() && currentDate.isNotEmpty()) {
//
//                for (i in pendinglist.indices) {
//                    var omsOrderno = pendinglist.get(i).omsorderno!!.toUpperCase()
//                    var site = pendinglist.get(i).storeid!!.toUpperCase()
...
//                    var reqDate = formatQcdate(pendinglist.get(i).requesteddate!!)
//
//                    if (fromDate.equals(currentDate)&&site.contains(siteId) && typeString.equals("FORWARD RETURN") && omsOrderno.contains(
//                            "FL")&&(Utlis.filterDateFormate(fromDate)
//                            .equals(Utlis.filterDateFormate(reqDate)))||(Utlis.filterDateFormate(currentDate)
//                            .equals(Utlis.filterDateFormate(reqDate)))  ) {
//                        orderTypeFilteredPendinglist.add(pendinglist.get(i))
//
//
//                    } else if (site.contains(siteId) && typeString.equals("FORWARD RETURN") && omsOrderno.contains(
//                            "FL"
//                    ) && (Utlis.filterDateFormate(fromDate)
//                            .before(Utlis.filterDateFormate(reqDate))) && (Utlis.filterDateFormate(
//                            currentDate
...
//                    ) {
//                        orderTypeFilteredPendinglist.add(pendinglist.get(i))
//                    } else if (site.contains(siteId) && typeString.equals("REVERSE RETURN") && omsOrderno.contains(
//                            "RT"
//                    ) && (Utlis.filterDateFormate(fromDate)
//                            .before(Utlis.filterDateFormate(reqDate))) && (Utlis.filterDateFormate(
//                            currentDate
...
//                }
//                return orderTypeFilteredPendinglist
//            } else if (typeString.isNotEmpty() && regionId.isNotEmpty() && siteId.isEmpty() && fromDate.isNotEmpty() && currentDate.isNotEmpty()) {
//
//                for (i in pendinglist.indices) {
//                    var omsOrderno = pendinglist.get(i).omsorderno!!.toUpperCase()
//                    var site = pendinglist.get(i).storeid!!.toUpperCase()
...
//
//
//                    if (region!!.contains(regionId) && typeString.equals("FORWARD RETURN") && omsOrderno.contains(
//                            "FL"
//                    ) && (Utlis.filterDateFormate(fromDate)
//                            .before(Utlis.filterDateFormate(reqDate))) && (Utlis.filterDateFormate(
//                            currentDate
...
//                ) {
//                        orderTypeFilteredPendinglist.add(pendinglist.get(i))
//                    } else if (region!!.contains(regionId) && typeString.equals("REVERSE RETURN") && omsOrderno.contains(
//                            "RT"
//                    ) && (Utlis.filterDateFormate(fromDate)
//                            .before(Utlis.filterDateFormate(reqDate))) && (Utlis.filterDateFormate(
//                            currentDate
...
//                }
//                return orderTypeFilteredPendinglist
//            } else if (typeString.isEmpty() && storeIdList.size > 1 && regionIdList.size > 1 && fromDate.isNotEmpty() && currentDate.isNotEmpty()) {
//                for (i in pendinglist) {
//                    var omsOrderno = i.omsorderno!!.toUpperCase()
//                    var site = i.storeid!!.toUpperCase()
//                    var region = i.dcCode
...
//                }
//                return orderTypeFilteredPendinglist
//            } else if (typeString.isNotEmpty() && storeIdList.size > 1 && regionIdList.isEmpty() && fromDate.isNotEmpty() && currentDate.isNotEmpty()) {
//                for (i in pendinglist) {
//                    var omsOrderno = i.omsorderno!!.toUpperCase()
//                    var site = i.storeid!!.toUpperCase()
//                    var region = i.dcCode
...
//                }
//                return orderTypeFilteredPendinglist
//            } else if (typeString.isNotEmpty() && storeIdList.isEmpty() && regionIdList.size > 1 && fromDate.isNotEmpty() && currentDate.isNotEmpty()) {
//                for (i in pendinglist) {
//                    var omsOrderno = i.omsorderno!!.toUpperCase()
//                    var site = i.storeid!!.toUpperCase()
//                    var region = i.dcCode
...
//
//
//            else if (storeIdList.isEmpty() && siteId.isNotEmpty() && regionId.isEmpty() && fromDate.isEmpty() && currentDate.isEmpty() && typeString.isEmpty()) {
//
//                for (i in pendinglist) {
//                    var omsOrderno = i.omsorderno!!.toUpperCase()
//                    var site = i.storeid!!.toUpperCase()
...
//                }
//                return orderTypeFilteredPendinglist
//            } else if (regionIdList.isEmpty() && regionId.isNotEmpty() && siteId.isEmpty() && fromDate.isEmpty() && currentDate.isEmpty() && typeString.isEmpty()) {
//
//                for (i in pendinglist) {
//                    var omsOrderno = i.omsorderno!!.toUpperCase()
//                    var site = i.storeid!!.toUpperCase()
...
//                }
//                return orderTypeFilteredPendinglist
//            } else if (storeIdList.isEmpty() && regionIdList.isEmpty() && typeString.isNotEmpty() && fromDate.isEmpty() && currentDate.isEmpty()) {
//
//                for (i in pendinglist) {
//                    var omsOrderno = i.omsorderno!!.toUpperCase()
//                    var site = i.storeid!!.toUpperCase()
...
//                }
//                return orderTypeFilteredPendinglist
//            } else if (storeIdList.isEmpty() && regionIdList.isEmpty() && siteId.isNotEmpty() && regionId.isNotEmpty() && typeString.isEmpty() && fromDate.isEmpty() && currentDate.isEmpty()) {
//
//                for (i in pendinglist) {
//                    var omsOrderno = i.omsorderno!!.toUpperCase()
//                    var site = i.storeid!!.toUpperCase()
...
//                }
//                return orderTypeFilteredPendinglist
//            } else if (regionIdList.isEmpty() && typeString.isNotEmpty() && regionId.isNotEmpty() && fromDate.isEmpty() && currentDate.isEmpty() && siteId.isEmpty()) {
//
//                for (i in pendinglist) {
//                    var omsOrderno = i.omsorderno!!.toUpperCase()
//                    var site = i.storeid!!.toUpperCase()
...
//                }
//                return orderTypeFilteredPendinglist
//            } else if (storeIdList.isEmpty() && typeString.isNotEmpty() && siteId.isNotEmpty() && fromDate.isEmpty() && currentDate.isEmpty() && regionId.isEmpty()) {
//
//                for (i in pendinglist) {
//                    var omsOrderno = i.omsorderno!!.toUpperCase()
//                    var site = i.storeid!!.toUpperCase()
...
//
////            subList = ListUtils.partition(it.pendinglist, 3)
//                    splitTheArrayList(it.pendinglist)
//                    pageNo = 1
//                    increment = 0
//                    if (pageNo == 1) {
//                        viewBinding.prevPage.visibility = View.INVISIBLE
...
//
//                        if (currentDate.isNotEmpty() && fromDate.isNotEmpty() && siteId.isEmpty() && regionId.isEmpty() && typeString.isEmpty()) {
//                            showLoading()
//                            viewModel.getQcPendingList(
//                                    Preferences.getToken(),
