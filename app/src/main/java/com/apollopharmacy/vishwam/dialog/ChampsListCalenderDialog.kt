...
class ChampsListCalenderDialog : DialogFragment() {
    ...
    companion object {
        ...
        const val KEY_VISIT_DATE = "visit_date_value"
    }
...
//        calendar.add(Calendar.DATE, -PROBLEM_SINCE_DAYS);
        ...
        dataPickerBinding.datePicker.setMinDate(calendar.getTimeInMillis());
