...
public class PopUpWIndowQr extends PopupWindow {
    ...
    public PopUpWIndowQr(Context ctx, int layout, View v, String imageUrl, Bitmap bitmap, String category, int imagePosition) {
        super(((LayoutInflater) ctx.getSystemService(LAYOUT_INFLATER_SERVICE)).inflate(R.layout.popup_imageview_qr, null), ViewGroup.LayoutParams.MATCH_PARENT,
        ...
        ImageButton closeButton = this.view.findViewById(R.id.ib_close_qr);
