...
public class PopUpWIndowChamps extends PopupWindow {
    ...
    public PopUpWIndowChamps(Context ctx, int layout, View v, String imageUrl, Bitmap bitmap, String category, int imagePosition) {
        super(((LayoutInflater) ctx.getSystemService(LAYOUT_INFLATER_SERVICE)).inflate(R.layout.layout_image_fullview_champs, null), ViewGroup.LayoutParams.MATCH_PARENT,
        ...
        ImageView rotateIcon = this.view.findViewById(R.id.rotateImageChamps);
