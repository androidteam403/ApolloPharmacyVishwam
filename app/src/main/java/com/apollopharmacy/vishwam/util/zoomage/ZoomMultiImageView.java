package com.apollopharmacy.vishwam.util.zoomage;
 ...
 * visible window.
 */
public class ZoomMultiImageView  extends AppCompatImageView implements OnScaleGestureListener {

    private static final float MIN_SCALE = 0.6f;
    private static final float MIN_SCALE_TEST = 0.6f;
    ...
    private ZoomMultiImageView imageView1;
    private ZoomMultiImageView imageView2;
    @AutoResetMode
    ...
    public ZoomMultiImageView(Context context) {
        super(context);
        init(context, null);
    }

    public ZoomMultiImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ZoomMultiImageView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    public void setImageView1(final ZoomMultiImageView imageView1) {
        this.imageView1 = imageView1;
    }

    public void setImageView2(final ZoomMultiImageView imageView2) {
    ...
    private void updateBounds(final float[] values) {
        ...
        if (imageView1 == null) {
            bounds.set(values[Matrix.MTRANS_X],
                    values[Matrix.MTRANS_Y],
                    imageView2.getDrawable().getIntrinsicWidth() * values[Matrix.MSCALE_X] + values[Matrix.MTRANS_X],
                    imageView2.getDrawable().getIntrinsicHeight() * values[Matrix.MSCALE_Y] + values[Matrix.MTRANS_Y]);
        } else if (imageView2 == null) {
            bounds.set(values[Matrix.MTRANS_X],
                    values[Matrix.MTRANS_Y],
                    imageView1.getDrawable().getIntrinsicWidth() * values[Matrix.MSCALE_X] + values[Matrix.MTRANS_X],
                    imageView1.getDrawable().getIntrinsicHeight() * values[Matrix.MSCALE_Y] + values[Matrix.MTRANS_Y]);
    ...
    public void reset(final boolean animate) {
        if (animate) {
            ...
            if (imageView1 == null) {
                imageView2.setImageMatrix(startMatrix);
            } else if (imageView2 == null) {
                imageView1.setImageMatrix(startMatrix);
            }
        }
    }
    ...
    private void animateScaleAndTranslationToMatrix(final Matrix targetMatrix, final int duration) {
        ...
        resetAnimator.addUpdateListener(new AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (imageView1 == null) {
                    imageView2.setImageMatrix(activeMatrix);
                } else if (imageView2 == null) {
                    imageView1.setImageMatrix(activeMatrix);
                }
            }
        });
        ...
        resetAnimator.addListener(new SimpleAnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (imageView1 == null) {
                    imageView2.setImageMatrix(targetMatrix);
                } else if (imageView2 == null) {
                    imageView1.setImageMatrix(targetMatrix);
                }
            }
        });
    ...
    private void animateMatrixIndex(final int index, final float to) {
        ...
        animator.addUpdateListener(new AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (imageView1 == null) {
                    imageView2.setImageMatrix(current);
                } else if (imageView2 == null) {
                    imageView1.setImageMatrix(current);
                }
            }
        });
