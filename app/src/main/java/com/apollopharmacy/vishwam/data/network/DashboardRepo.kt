...
object DashboardRepo {
    ...
    suspend fun getTicketCountByStatus(startDate: String, endDate: String, id: String): ApiResult<TicketCountsByStatusRoleResponse> {
        return try {
            val response = Api.getClient().GET_TICKET_COUNT_BY_STATUS(startDate, endDate, id)
