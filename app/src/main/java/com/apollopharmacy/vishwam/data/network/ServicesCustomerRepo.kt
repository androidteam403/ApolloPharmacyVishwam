...
object ServicesCustomerRepo {

    suspend fun getCategoryDetails(
        url: String,
        token: String,
        ): ApiResult<GetServicesCustomerResponse> {
        return try {
            val response = Api.getClient().getCategoryDetails(url, token)
    ...
    ): ApiResult<HomeServiceDetailsResponse> {
        return try {
            val response =
                Api.getClient().getHomeServiceDetails(url, token, homeServiceDetailsRequest)
            ApiResult.Success(response)
        } catch (e: Exception) {
            ApiResult.UnknownError(e.message)
        } catch (e: IOException) {
    ...
    ): ApiResult<HomeServicesSaveDetailsResponse> {
        return try {
            val response =
                Api.getClient().getHomeServicesSaveDetails(url, token, homeServicesSaveDetailsRequest)
            ApiResult.Success(response)
        } catch (e: Exception) {
            ApiResult.UnknownError(e.message)
        } catch (e: IOException) {
