...
data class ReasonmasterV2Response(
    ...
    data class Row(
        ...
        @field:SerializedName("allow_duplicate_st_creation")
        val allow_duplicate_st_creation: AllowDuplicateStCreation,
    ...
    data class AllowDuplicateStCreation(
