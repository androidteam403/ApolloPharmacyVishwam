...
//    ): DeviceDeRegResponse
    ...
    @POST("https://172.16.103.116:8443/mrodvend/APOLLO/Vendor/VALIDATEVENDOR")//("https://172.16.103.116:8443/mrodvend/APOLLO/Vendor/VALIDATEVENDOR")
    suspend fun getValidate(@Header("token") token: String, @Body data: CommonRequest): String

    //"https://viswam.apollopharmacy.org/mprodvend/APOLLO/Vendor/VALIDATEVENDOR"
